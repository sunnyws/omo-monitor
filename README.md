...
**会话列表** -- 显示所有父会话、Token 用量、运行状态

![会话列表](./assets/image-20260526105305553.png)

**Agent 列表** -- 显示子会话的 Agent、模型、耗时

![Agent 列表](./assets/image-20260526105425614.png)

**Agent 详情** -- 活动日志，中文工具名，颜色区分

![Agent 详情](./assets/image-20260526133420019.png)
